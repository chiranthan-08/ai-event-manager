...
const categoryData = {
  Wedding: {
    ...
    events: [
      { id: 'w1', title: 'Priya & Rahul Royal Wedding', venue: 'Taj Palace, Jaipur', date: '2026-08-25', time: '6:00 PM', status: 'live', viewers: 1240, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=600&h=400&fit=crop', description: 'A grand Rajasthani wedding with 800+ guests, traditional rituals, and royal decor.' },
      { id: 'w2', title: 'Anita & Meera Garden Wedding', venue: 'Leela Palace, Bangalore', date: '2026-08-28', time: '5:30 PM', status: 'upcoming', viewers: 0, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=600&h=400&fit=crop', description: 'Intimate garden wedding with floral mandap and candlelit reception.' },
      { id: 'w3', title: 'Kavya & Arjun Beach Wedding', venue: 'Grand Hyatt, Goa', date: '2026-09-02', time: '4:00 PM', status: 'live', viewers: 890, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=600&h=400&fit=crop', description: 'Sunset beach wedding with white mandap and seashell decorations.' },
      { id: 'w4', title: 'Neha & Vikram Heritage Wedding', venue: 'Umaid Bhawan, Jodhpur', date: '2026-09-05', time: '7:00 PM', status: 'upcoming', viewers: 0, rating: 5.0, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: 'Palace wedding with horse carriage entry and fireworks display.' },
    ],
  },
  Birthday: {
    icon: '🎂',
    ...
    events: [
      { id: 'b1', title: 'Arjun 5th Birthday Bash', venue: 'Fun World, Mumbai', date: '2026-08-26', time: '11:00 AM', status: 'live', viewers: 320, rating: 4.6, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&h=400&fit=crop', description: 'Superhero themed party with character appearances, games, and magic show.' },
      { id: 'b2', title: 'Meera Sweet 16 Celebration', venue: 'Grand Ballroom, Delhi', date: '2026-08-30', time: '7:00 PM', status: 'live', viewers: 560, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&h=400&fit=crop', description: 'Neon glow themed sweet sixteen with DJ, photo booth, and LED dance floor.' },
      { id: 'b3', title: 'Twins 3rd Birthday Carnival', venue: 'Park Hyatt, Chennai', date: '2026-09-01', time: '10:00 AM', status: 'upcoming', viewers: 0, rating: 4.5, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&h=400&fit=crop', description: 'Carnival themed party with rides, cotton candy station, and balloon artists.' },
      { id: 'b4', title: 'Grandpa 75th Birthday', venue: 'Heritage Resort, Coorg', date: '2026-09-03', time: '6:00 PM', status: 'upcoming', viewers: 0, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&h=400&fit=crop', description: 'Elegant milestone celebration with family tribute video and live classical music.' },
    ],
  },
  Corporate: {
    icon: '💼',
    ...
    events: [
      { id: 'c1', title: 'TechSummit 2026', venue: 'BIEC, Bangalore', date: '2026-08-27', time: '9:00 AM', status: 'live', viewers: 3200, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop', description: 'Annual tech conference with 2000+ attendees, LED stage, and live demos.' },
      { id: 'c2', title: 'Infosys Annual Day', venue: 'Phoenix MarketCity, Mumbai', date: '2026-09-04', time: '6:00 PM', status: 'upcoming', viewers: 0, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop', description: 'Corporate annual celebration with awards ceremony and live band performance.' },
      { id: 'c3', title: 'Startup Launch Event', venue: 'WeWork, Hyderabad', date: '2026-08-29', time: '4:00 PM', status: 'live', viewers: 1800, rating: 4.6, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop', description: 'Product launch with investor meet, live demo, and networking dinner.' },
      { id: 'c4', title: 'Banking Conference', venue: 'ITC Maurya, Delhi', date: '2026-09-06', time: '10:00 AM', status: 'upcoming', viewers: 0, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop', description: 'Banking industry summit with keynote speakers and panel discussions.' },
    ],
  },
  College: {
    icon: '🎓',
    ...
    events: [
      { id: 'co1', title: 'IIT Bombay Mood Indigo', venue: 'IIT Bombay Campus', date: '2026-08-25', time: '5:00 PM', status: 'live', viewers: 5600, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', description: 'India\'s largest cultural festival with 200+ events and celebrity performances.' },
      { id: 'co2', title: 'Christ University Fest', venue: 'Christ University, Bangalore', date: '2026-09-01', time: '6:00 PM', status: 'upcoming', viewers: 0, rating: 4.6, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', description: 'Annual college fest with fashion show, band night, and cultural performances.' },
      { id: 'co3', title: 'SRM University Farewell', venue: 'SRM Campus, Chennai', date: '2026-08-31', time: '7:00 PM', status: 'live', viewers: 2100, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', description: 'Grand farewell celebration with awards, performances, and memory lane.' },
      { id: 'co4', title: 'Manipal Tech Fest', venue: 'MIT Campus, Manipal', date: '2026-09-05', time: '9:00 AM', status: 'upcoming', viewers: 0, rating: 4.5, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', description: 'Technology festival with hackathons, robotics, and AI workshops.' },
    ],
  },
  Festival: {
    icon: '🪔',
    ...
    events: [
      { id: 'f1', title: 'Diwali Mahaotsav 2026', venue: 'Lotus Temple, Delhi', date: '2026-08-26', time: '6:30 PM', status: 'live', viewers: 8900, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1567880564951-5ea4251fd4be?w=600&h=400&fit=crop', description: 'Grand Diwali celebration with 10,000 diyas, rangoli competition, and cultural performances.' },
      { id: 'f2', title: 'Holi Rang Mahotsav', venue: 'Mathura, UP', date: '2026-09-02', time: '10:00 AM', status: 'upcoming', viewers: 0, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1551818255-e6e10975bc17?w=600&h=400&fit=crop', description: 'Traditional Holi celebration with organic colors, music, and food stalls.' },
      { id: 'f3', title: 'Ganesh Chaturthi', venue: 'Lalbaugcha Raja, Mumbai', date: '2026-08-28', time: '8:00 AM', status: 'live', viewers: 12000, rating: 5.0, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1567880564951-5ea4251fd4be?w=600&h=400&fit=crop', description: 'Grand Ganesh immersion procession with 500+ idols and cultural troupes.' },
      { id: 'f4', title: 'Onam Sadya Celebration', venue: 'Kovalam Beach, Kerala', date: '2026-09-04', time: '12:00 PM', status: 'upcoming', viewers: 0, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1567880564951-5ea4251fd4be?w=600&h=400&fit=crop', description: 'Traditional Onam celebration with Pookalam, snake boat race, and Onam Sadya.' },
    ],
  },
  Party: {
    icon: '🎉',
  ...
  Anniversary: {
    ...
    events: [
      { id: 'a1', title: 'Silver Jubilee Celebration', venue: 'Leela Palace, Udaipur', date: '2026-08-27', time: '7:00 PM', status: 'live', viewers: 680, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: '25th anniversary with rose petal decor, candlelight dinner, and live violin.' },
      { id: 'a2', title: 'Gold Anniversary Gala', venue: 'Taj Coromandel, Chennai', date: '2026-09-03', time: '6:30 PM', status: 'upcoming', viewers: 0, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: '50th anniversary celebration with family tribute and grand reception.' },
      { id: 'a3', title: 'First Anniversary Surprise', venue: 'Backwater Resort, Kerala', date: '2026-08-30', time: '5:00 PM', status: 'live', viewers: 420, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: 'Houseboat surprise with rose petals, private dinner, and fireworks.' },
      { id: 'a4', title: 'Grandparents Day Special', venue: 'Hyatt Regency, Pune', date: '2026-09-05', time: '11:00 AM', status: 'upcoming', viewers: 0, rating: 4.6, youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: 'Multi-generational family celebration with tribute video and live music.' },
    ],
  },
};
