...
const categoryData = {
  Wedding: {
    ...
    events: [
      { id: 'w1', title: 'Priya & Rahul Royal Wedding', venue: 'Taj Palace, Jaipur', date: '2026-08-25', time: '6:00 PM', status: 'live', viewers: 1240, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/rCUY6uy3Q8w', thumbnail: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=600&h=400&fit=crop', description: 'A grand Rajasthani wedding with 800+ guests, traditional rituals, and royal decor.' },
      { id: 'w2', title: 'Anita & Meera Garden Wedding', venue: 'Leela Palace, Bangalore', date: '2026-08-28', time: '5:30 PM', status: 'upcoming', viewers: 0, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/B1FrCuNcnEk', thumbnail: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=600&h=400&fit=crop', description: 'Intimate garden wedding with floral mandap and candlelit reception.' },
      { id: 'w3', title: 'Kavya & Arjun Beach Wedding', venue: 'Grand Hyatt, Goa', date: '2026-09-02', time: '4:00 PM', status: 'live', viewers: 890, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/iX0w_XTMhnk', thumbnail: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=600&h=400&fit=crop', description: 'Sunset beach wedding with white mandap and seashell decorations.' },
      { id: 'w4', title: 'Neha & Vikram Heritage Wedding', venue: 'Umaid Bhawan, Jodhpur', date: '2026-09-05', time: '7:00 PM', status: 'upcoming', viewers: 0, rating: 5.0, youtubeUrl: 'https://www.youtube.com/embed/drC_A30oT2U', thumbnail: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=600&h=400&fit=crop', description: 'Palace wedding with horse carriage entry and fireworks display.' },
    ],
  },
  Birthday: {
    icon: '🎂',
  ...
  Corporate: {
    ...
    events: [
      { id: 'c1', title: 'TechSummit 2026 Annual Conference', venue: 'Jio Convention Centre, Mumbai', date: '2026-08-30', time: '9:00 AM', status: 'live', viewers: 5200, rating: 4.8, youtubeUrl: 'https://www.youtube.com/embed/1yI33ULWhpI', thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop', description: 'India\'s largest tech conference with 50+ speakers and 10,000 attendees.' },
      { id: 'c2', title: 'StartupIndia Annual Gala', venue: 'Vigyan Bhavan, New Delhi', date: '2026-09-01', time: '6:00 PM', status: 'upcoming', viewers: 0, rating: 4.6, youtubeUrl: 'https://www.youtube.com/embed/ipz7FsPi8WU', thumbnail: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=600&h=400&fit=crop', description: 'Annual startup awards night celebrating India\'s top 100 innovators.' },
      { id: 'c3', title: 'IIFA Awards Night 2026', venue: 'DY Patil Stadium, Mumbai', date: '2026-09-03', time: '7:30 PM', status: 'live', viewers: 15800, rating: 4.9, youtubeUrl: 'https://www.youtube.com/embed/nkov64jauOM', thumbnail: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=600&h=400&fit=crop', description: 'Bollywood\'s biggest night with A-list celebrities and live performances.' },
      { id: 'c4', title: 'FinTech Innovators Summit', venue: 'IIIT Hyderabad', date: '2026-09-06', time: '10:00 AM', status: 'upcoming', viewers: 0, rating: 4.7, youtubeUrl: 'https://www.youtube.com/embed/TvutM7t3uHA', thumbnail: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&h=400&fit=crop', description: 'Banking leaders discuss future of UPI, crypto regulation, and digital lending.' },
    ],
  },
  College: {
    icon: '🎓',
    ...
    events: [
      ...
      { id: 'co4', title: 'Manipal Tech Fest', venue: 'MIT Campus, Manipal', date: '2026-09-05', time: '9:00 AM', status: 'upcoming', viewers: 0, rating: 4.5, youtubeUrl: 'https://www.youtube.com/embed/Wds9iKicx0Y', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', description: 'Technology festival with hackathons, robotics, and AI workshops.' },
    ],
  },
  Festival: {
    icon: '🪔',
