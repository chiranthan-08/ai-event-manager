            ...
            {data?.upcomingEvents?.length > 0 ? (
              data.upcomingEvents.map((event) => (
                <div key={event._id} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                  <img src={event.images?.[0] || 'https://images.pexels.com/photos/1444442/pexels-photo-1444442.jpeg?w=100&h=100&fit=crop'} alt={event.title} className="w-12 h-12 rounded-lg object-cover" />
